...
func (s *SFrame) Data() []byte {
	// fmt.Println("-------")
	// fmt.Println(s.RecvSN)
	// fmt.Println([]byte{byte(0b1), byte(0b0), byte(s.RecvSN << 1 & 0b11111110), byte(s.RecvSN >> 7)})
	// fmt.Println("-------")
	return []byte{byte(0b1), byte(0b0), byte(s.RecvSN << 1 & 0b11111110), byte(s.RecvSN >> 7)}
}
